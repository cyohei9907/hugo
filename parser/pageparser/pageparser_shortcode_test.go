...
var (
	...
	tstParamName1     = nti(tScParamName, "param1")
	tstParamName2     = nti(tScParamName, "param2")
	tstParamString1   = nti(tScParamString, "param1")
	tstParamString2   = nti(tScParamString, "param2")
	tstParamBoolTrue  = nti(tScParamBool, "true")
	tstParamBoolFalse = nti(tScParamBool, "false")
	tstParamInt       = nti(tScParamInt, "32")
	tstParamFloat     = nti(tScParamFloat, "3.14")
	tstVal            = nti(tScParamString, "Hello World")
...
var shortCodeLexerTests = []lexerTest{
	...
	{"Youtube id", `{{< sc1 -ziL-Q_456igdO-4 >}}`, []Item{
		tstLeftNoMD, tstSC1, nti(tScParamString, "-ziL-Q_456igdO-4"), tstRightNoMD, tstEOF}},
	{"Params types", `{{< sc1 true false 32 3.14 >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamBoolTrue, tstParamBoolFalse, tstParamInt, tstParamFloat, tstRightNoMD, tstEOF}},
	{"Params types named", `{{< sc1 param1=true param2=3.14 >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName1, tstParamBoolTrue, tstParamName2, tstParamFloat, tstRightNoMD, tstEOF}},
	{"Params types named, spaces", `{{< sc1 param1=   true param2   =3.14 >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName1, tstParamBoolTrue, tstParamName2, tstParamFloat, tstRightNoMD, tstEOF}},
	{"non-alphanumerics param quoted", `{{< sc1 "-ziL-.%QigdO-4" >}}`, []Item{
		tstLeftNoMD, tstSC1, nti(tScParamString, "-ziL-.%QigdO-4"), tstRightNoMD, tstEOF}},
	{"two params", `{{< sc1 param1   param2 >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamString1, tstParamString2, tstRightNoMD, tstEOF}},
	// issue #934
	...
	{"self-closing with param", `{{< sc1 param1 />}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamString1, tstSCClose, tstRightNoMD, tstEOF}},
	{"multiple self-closing with param", `{{< sc1 param1 />}}{{< sc1 param1 />}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamString1, tstSCClose, tstRightNoMD,
		tstLeftNoMD, tstSC1, tstParamString1, tstSCClose, tstRightNoMD, tstEOF}},
	{"multiple different self-closing with param", `{{< sc1 param1 />}}{{< sc2 param1 />}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamString1, tstSCClose, tstRightNoMD,
		tstLeftNoMD, tstSC2, tstParamString1, tstSCClose, tstRightNoMD, tstEOF}},
	...
	{"nested complex", `{{< sc1 >}}ab{{% sc2 param1 %}}cd{{< sc3 >}}ef{{< /sc3 >}}gh{{% /sc2 %}}ij{{< /sc1 >}}kl`, []Item{
		tstLeftNoMD, tstSC1, tstRightNoMD,
		nti(tText, "ab"),
		tstLeftMD, tstSC2, tstParamString1, tstRightMD,
		nti(tText, "cd"),
	...
	{"two quoted params", `{{< sc1 "param nr. 1" "param nr. 2" >}}`, []Item{
		tstLeftNoMD, tstSC1, nti(tScParamString, "param nr. 1"), nti(tScParamString, "param nr. 2"), tstRightNoMD, tstEOF}},
	{"two named params", `{{< sc1 param1="Hello World" param2="p2Val">}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName1, tstVal, tstParamName2, nti(tScParamString, "p2Val"), tstRightNoMD, tstEOF}},
	{"escaped quotes", `{{< sc1 param1=\"Hello World\"  >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName1, tstVal, tstRightNoMD, tstEOF}},
	{"escaped quotes, positional param", `{{< sc1 \"param1\"  >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamString1, tstRightNoMD, tstEOF}},
	{"escaped quotes inside escaped quotes", `{{< sc1 param1=\"Hello \"escaped\" World\"  >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName1,
		nti(tScParamString, `Hello `), nti(tError, `got positional parameter 'escaped'. Cannot mix named and positional parameters`)}},
	{"escaped quotes inside nonescaped quotes",
		`{{< sc1 param1="Hello \"escaped\" World"  >}}`, []Item{
			tstLeftNoMD, tstSC1, tstParamName1, nti(tScParamString, `Hello "escaped" World`), tstRightNoMD, tstEOF}},
	{"escaped quotes inside nonescaped quotes in positional param",
		`{{< sc1 "Hello \"escaped\" World"  >}}`, []Item{
			tstLeftNoMD, tstSC1, nti(tScParamString, `Hello "escaped" World`), tstRightNoMD, tstEOF}},
	{"unterminated quote", `{{< sc1 param2="Hello World>}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName2, nti(tError, "unterminated quoted string in shortcode parameter-argument: 'Hello World>}}'")}},
	{"one named param, one not", `{{< sc1 param1="Hello World" p2 >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamName1, tstVal,
	...
	{"one quoted positional param, one named param", `{{< sc1 "param1" param2="And Universe" >}}`, []Item{
		tstLeftNoMD, tstSC1, tstParamString1,

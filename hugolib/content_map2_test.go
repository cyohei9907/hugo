...
`
	...
	c.Run("cleanKey", func(c *qt.C) {
		...
		for _, test := range []struct {
			...
			c.Assert(m.cleanKey(test.in), qt.Equals, test.expected)
	...
	b.AssertFileContent("public/index.html",
	 ...
	 Num Regular: 7
      ...
      Home: Hugo Home|/|2019-06-08|Current Section: |Resources: 
        ...
        Sections: /blog/|/docs/|
        Categories: /categories/funny/; funny; 7|
        Category Terms:  taxonomyTerm: /categories/funny/; funny; 7|
        Category Funny:  taxonomy; funny: /blog/subsection/page4/;|/blog/page3/;|/blog/page2/;|/blog/page1/;|/blog/subsection/page5/;|/docs/page6/;|/blog/bundle/;|
        Pag Num Pages: 7
